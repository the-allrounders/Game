        ...
        private readonly string[,] questions = {
			...
			{"Wat is de grootste actieve vulkaan in Europa?", 
               "1) Vesuvius","2) Stromboli", "3) Etna", "4) Vulcano",
                "De Etna ligt in Italie en is met zijn ruim 3300 meter hoogte de grootste van Europa!"},   
			...
			{"Welk land heeft de meeste vulkanen?", 
                ...
                "Indonesie is met zijn 150 vulkanen het land met de meeste vulkanen ter wereld! Hiervan is ruim de helft actief, waardoor er regelmatig uitbarstingen zijn."},
